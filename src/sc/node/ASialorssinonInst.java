...
public final class ASialorssinonInst extends PInst
{
    private TSi _si_;
    private PExp _exp_;
    private TAlors _alors_;
    private PBi _premier_;
    private TSinon _sinon_;
    private PBi _second_;

    public ASialorssinonInst()
    {
        // Constructor
    }
    ...
    public ASialorssinonInst(
        ...
        @SuppressWarnings("hiding") PBi _premier_,
        @SuppressWarnings("hiding") TSinon _sinon_,
        @SuppressWarnings("hiding") PBi _second_)
    {
        // Constructor
        setSi(_si_);
    ...
    {
        ((Analysis) sw).caseASialorssinonInst(this);
    }
    ...
    public PBi getPremier()
    {
        return this._premier_;
    }

    public void setPremier(PBi node)
    {
    ...
    public PBi getSecond()
    {
        return this._second_;
    }

    public void setSecond(PBi node)
    {
