...
public final class AListedeclarationfonctionLdf extends PLdf
{
    private PDf _df_;
    private PLdf _ldf_;

    public AListedeclarationfonctionLdf()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListedeclarationfonctionLdf(
            cloneNode(this._df_),
    ...
    {
        ((Analysis) sw).caseAListedeclarationfonctionLdf(this);
    }
